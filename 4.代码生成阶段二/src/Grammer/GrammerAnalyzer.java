                ...
                if (GrammerAnalyzerOutput.get(index).getCategoryCode().equals("LPARENT")) {
                    ...
                    if (GrammerAnalyzerOutput.get(index).getCategoryCode().equals("RPARENT")) {
                        ...
                        if (GrammerAnalyzerOutput.get(index).getCategoryCode().equals("LBRACE")) {
                            ...
                            res.add("<FuncDef>");
//                            System.out.println("-----------------------------------------------------------");
//                            System.out.println(GrammerAnalyzerOutput.get(index - 5).getValue());
//                            System.out.println(GrammerAnalyzerOutput.get(index - 4).getValue());
//                            System.out.println(GrammerAnalyzerOutput.get(index - 3).getValue());
//                            System.out.println(GrammerAnalyzerOutput.get(index - 2).getValue());
//                            System.out.println(GrammerAnalyzerOutput.get(index - 1).getValue());
//                            System.out.println("-----------------------------------------------------------");
                            //todo:出大锅 无法判断最后一条item是return的情况.
                            if (!isIntFunc){
//                                if((!codelist.get(codelist.size()-1).getName().equals("RET")) &&
//                                        (GrammerAnalyzerOutput.get(index - 4).getValue().equals(";")) &&
